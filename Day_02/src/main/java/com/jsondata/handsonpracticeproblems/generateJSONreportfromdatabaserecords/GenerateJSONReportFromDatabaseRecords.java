package com.jsondata.handsonpracticeproblems.generateJSONreportfromdatabaserecords;
...
public class GenerateJSONReportFromDatabaseRecords {
    public static void main(String[] args) {
        ...
        try {
            ...
            objectMapper.writeValue(new File("src/main/java/com/jsondata/handsonpracticeproblems/generateJSONreportfromdatabaserecords/students_report.json"), students);
