package com.csvdatahandling.advanceproblems.generateacsvreportfromdatabase;
...
public class EmployeeCSVReport {
    public static void main(String[] args) {
        ...
        String csvFile = "src/main/java/com/csvdatahandling/advanceproblems/generateacsvreportfromdatabase/file.csv";
