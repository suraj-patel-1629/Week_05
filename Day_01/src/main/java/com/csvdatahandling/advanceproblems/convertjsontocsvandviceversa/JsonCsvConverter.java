...
public class JsonCsvConverter {
    ...
    public static void main(String[] args) throws IOException {
        String jsonFile = "src/main/java/com/csvdatahandling/advanceproblems/convertjsontocsvandviceversa/students.json";
        String csvFile = "src/main/java/com/csvdatahandling/advanceproblems/convertjsontocsvandviceversa/students.csv";
        String outputJsonFile = "src/main/java/com/csvdatahandling/advanceproblems/convertjsontocsvandviceversa/output_students.json";
